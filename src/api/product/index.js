...
import { create, index, show, update, destroy, seed } from './controller'
import { schema } from './model'
export Product, { schema } from './model'

const router = new Router()
const { name, pictures, description, category, total, price } = schema.tree
 ...
 * @apiParam total Product's total.
...
router.post('/',
  ...
  body({ name, pictures, description, category, total, price }),
  create)
 ...
 */
router.get('/',
  query({ category: { type: schema.objectId } }),
  index)
